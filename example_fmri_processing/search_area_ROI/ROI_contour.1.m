...
ROI_ext = {'_TR2_SNleft_peakvoxel.nii','_TR2_STNleft_peakvoxel.nii',...
    '_TR2_RNleft_peakvoxel.nii','_TR2_SNright_peakvoxel.nii',...
    '_TR2_STNright_peakvoxel.nii','_TR2_RNright_peakvoxel.nii',...
    '_TR2_VTAleft_peakvoxel.nii','_TR2_VTAright_peakvoxel.nii',...
    '_TR2_VTAbilateral_peakvoxel.nii',...
    '_TR2_VTAleft_extended_peakvoxel.nii',...
    '_TR2_VTAright_extended_peakvoxel.nii',...
    '_TR2_VTAbilateral_extended_peakvoxel.nii',...
    '_TR2_SNVTAleft_peakvoxel.nii','_TR2_SNVTAright_peakvoxel.nii',...
    '_TR2_SNVTAbilateral_peakvoxel.nii','_TR2_VTA_blob_peakvoxel.nii',...
    '_TR2_SNVTA_blob_peakvoxel.nii'};
...
for s = 1:length(subjects)
    ...
    for r = 1:length(ROI_ext)
        ...
        caxis([-1,3]);
        % save the figure
        saveas(h, regexprep(fullfile(save_dir,[subjects{s},ROI_ext{r}]),'.nii','.fig'),'fig');
