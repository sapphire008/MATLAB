...
clear all;
%directory of GLM
subject_dir = '/nfs/jong_exp/midbrain_pilots/mid/analysis/GLM/';
...
ROI_dir = '/nfs/jong_exp/midbrain_pilots/VTA_ROI_localization/ROIs/TR2/';
ROI_name = {'_TR2_SNleft','_TR2_STNleft','_TR2_SNright','_TR2_STNright',...
    '_TR2_RNleft','_TR2_RNright','_TR2_VTAleft','_TR2_VTAright',...
    '_TR2_VTAleft_extended','_TR2_VTAright_extended',...
    '_TR2_VTAbilateral','_TR2_VTAbilateral_extended',...
    '_TR2_SNVTAleft','_TR2_SNVTAright','_TR2_SNVTAbilateral',...
    '_TR2_VTA_blob','_TR2_SNVTA_blob'};
%ROI_name= {'_TR2_VTA_blob','_TR2_SNVTA_blob'};
worksheet_dir = '/nfs/jong_exp/midbrain_pilots/mid/analysis/ROI_peak_T_voxel/';
results_dir = '/nfs/jong_exp/midbrain_pilots/mid/analysis/ROI_peak_T_voxel/peak_T_ROIs/';
results_dir2 = '/nfs/jong_exp/midbrain_pilots/mid/analysis/ROI_peak_T_voxel/marked_ROIs/';
...
top_N = 1;%find top N peak voxels

% ------------------------ DO NOT EDIT BELOW ----------------------------
addspm8('NoConflicts');
addpath /usr/local/pkg64/matlabpackages/NIFTI/
...
for n = 1:length(subjects);
    ...
    for r = 1:length(ROI_name)
        ...
        % save the peak voxel ROI only when top 1 is selected
%         if top_N == 1
...
cell2csv(fullfile(worksheet_dir,['search_ROI_summary','_top',num2str(top_N),'.csv']),worksheet,',');
cd(worksheet_dir);%cd to the result directory
