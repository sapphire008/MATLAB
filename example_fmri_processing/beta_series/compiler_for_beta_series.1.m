...
clear all;
addpath(genpath('/nfs/pkg64/matlabpackages/xlwrite/'));
addpath('/nfs/pkg64/matlabpackages/ReadNWrite/');
addpath('/nfs/pkg64/matlabpackages/generic/');
addpath('/nfs/pkg64/matlabpackages/example_fmri_processing/beta_series/');
data_dir = '/hsgs/projects/jhyoon1/midbrain_pilots/haldol/mid_betas/';
...
file_suffix = {'_TR2_SNleft','_TR2_STNleft','_TR2_RNleft','_TR2_SNright',...
    '_TR2_STNright','_TR2_RNright','_TR2_VTAleft','_TR2_VTAright',...
    '_TR2_VTAbilateral','_TR2_VTAleft_extended','_TR2_VTAright_extended',...
    '_TR2_VTAbilateral_extended','_TR2_SNVTAleft','_TR2_SNVTAright',...
    '_TR2_SNVTAbilateral','_TR2_VTA_blob','_TR2_SNVTA_blob'};
file_ext = '.csv';
...
javaclasspath('/nfs/pkg64/matlabpackages/ReadNwrite/odfdom-java-0.8.7.jar');
javaaddpath('/nfs/pkg64/matlabpackages/xlwrite/poi_library/poi-3.8-20120326.jar');
javaaddpath('/nfs/pkg64/matlabpackages/xlwrite/poi_library/poi-ooxml-3.8-20120326.jar');
javaaddpath('/nfs/pkg64/matlabpackages/xlwrite/poi_library/poi-ooxml-schemas-3.8-20120326.jar');
javaaddpath('/nfs/pkg64/matlabpackages/xlwrite/poi_library/xmlbeans-2.3.0.jar');
javaaddpath('/nfs/pkg64/matlabpackages/xlwrite/poi_library/dom4j-1.6.1.jar');
