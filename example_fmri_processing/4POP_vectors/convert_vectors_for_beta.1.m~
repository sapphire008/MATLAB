vector_path = '/nfs/u3/SN_loc/behav/vectors/';
files = dir([vector_path,'AT19_1_vectors_*.mat']);
...
for n = 1:length(files),
    ...
    save([vector_path 'trial_wise/',prefix,'betavectors_',suffix],'names','onsets','durations')
end
