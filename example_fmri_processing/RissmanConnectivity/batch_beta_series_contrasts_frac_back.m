...
subject_dir='/hsgs/projects/jhyoon1/midbrain_pilots/frac_back/analysis/RissmanConnectivity/';
...
% list contrasts
% against null
positive_cons{1} = {'SNleft_Fixation'};
...
% SN-STN
positive_cons{9} = {'SNleft_Fixation'};
negative_cons{9} = {'STNleft_Fixation'};
...
% against fixation
positive_cons{13} = {'SNleft_ZeroBack'};
negative_cons{13} = {'SNleft_Fixation'};
...
% sums
positive_cons{19} = {'SNleft_ZeroBack','SNleft_OneBack','SNleft_TwoBack'};
negative_cons{19} = {'null'};
name(19) = {'SNleft_ZeroBack+OneBack+TwoBack-null'};
positive_cons{20} = {'SNleft_ZeroBack','SNleft_OneBack','SNleft_TwoBack'};
negative_cons{20} = {'SNleft_Fixation'};
...
positive_cons{23} = {'SNleft_ZeroBack','SNleft_OneBack','SNleft_TwoBack'};
negative_cons{23} = {'STNleft_ZeroBack','STNleft_OneBack','STNleft_TwoBack'};
name{23} = 'SNleft-STNleft_All_task_blocks';

positive_cons{24} = {'SNleft_TwoBack'};
negative_cons{24} = {'SNleft_OneBack'};
name(24) = {'SNleft_TwoBack-OneBack'};
positive_cons{25} = {'SNleft_OneBack'};
negative_cons{25} = {'SNleft_ZeroBack'};
name(25) = {'SNleft_OneBack-ZeroBack'};
positive_cons{26} = {'SNleft_TwoBack'};
negative_cons{26} = {'SNleft_ZeroBack'};
...
positive_cons{30} = {'SNleft_TwoBack','STNleft_OneBack'};
negative_cons{30} = {'SNleft_OneBack','STNleft_TwoBack'};
name(30) = {'SNleft-STNleft_TwoBack-OneBack'};
positive_cons{31} = {'SNleft_OneBack','STNleft_ZeroBack'};
negative_cons{31} = {'SNleft_ZeroBack','STNleft_OneBack'};
name(31) = {'SNleft-STNleft_OneBack-ZeroBack'};
positive_cons{32} = {'SNleft_TwoBack','STNleft_ZeroBack'};
negative_cons{32} = {'SNleft_ZeroBack','STNleft_TwoBack'};
