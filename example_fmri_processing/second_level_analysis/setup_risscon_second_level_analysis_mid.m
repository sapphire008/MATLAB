...
condnames = {'SNleft_Cue_gain5-null','SNleft_Cue_gain1-null',...
    'SNleft_Cue_gain0-null','SNleft_Cue_lose0-null','SNleft_Cue_lose1-null',...
    'SNleft_Cue_lose5-null','SNleft_Cue_gain5+gain1+gain0-null',...
    'SNleft_Cue_lose0+lose1+lose5-null','SNleft_Cue_gain5-gain0',...
    'SNleft_Cue_lose5-lose0','SNleft_Cue_gain1-gain0','SNleft_Cue_lose1-lose0',...
    'SNleft_Cue_gain5+lose5-gain0-lose0','SNleft_Cue_gain1+lose1-gain0-lose0',...
    'SNleft_Cue_gain+lose-zero','STNleft_Cue_gain5-null','STNleft_Cue_gain1-null',...
    'STNleft_Cue_gain0-null','STNleft_Cue_lose0-null','STNleft_Cue_lose1-null',...
    'STNleft_Cue_lose5-null','STNleft_Cue_gain5+gain1+gain0-null',...
    'STNleft_Cue_lose0+lose1+lose5-null','STNleft_Cue_gain5-gain0',...
    'STNleft_Cue_lose5-lose0','STNleft_Cue_gain1-gain0','STNleft_Cue_lose1-lose0',...
    'STNleft_Cue_gain5+lose5-gain0-lose0','STNleft_Cue_gain1+lose1-gain0-lose0',...
    'STNleft_Cue_gain+lose-zero','SNleft-STNleft_Cue_gain5','SNleft-STNleft_Cue_gain1',...
    'SNleft-STNleft_Cue_gain0','SNleft-STNleft_Cue_lose0','SNleft-STNleft_Cue_lose1',...
    'SNleft-STNleft_Cue_lose5','SNleft-STNleft_Cue_gain5+gain1+gain0',...
    'SNleft-STNleft_Cue_lose0+lose1+lose5','SNleft-STNleft_Cue_gain5+lose5-gain0-lose0',...
    'SNleft-STNleft_Cue_gain1+lose1-gain0-lose0','SNleft-STNleft_Cue_gain+lose-zero'};
groups = [repmat({'Controls'},1,18),repmat({'Patients'},1,6)];
source_dir = '/hsgs/projects/jhyoon1/midbrain_pilots/mid/analysis/RissmanConnectivity/';
save_dir = source_dir;
job_dir = '/hsgs/projects/jhyoon1/midbrain_pilots/mid/jobfiles/SecondLevel/';%where to save the jobs
source_image_label = 'R2Z';
RESULT_DIR = [];
%% Step 1: Second Level One-Sample T-Test: within group
save_job = 'riss_con_%s_OneSampleTTest.mat';
...
save_job = 'riss_con_%s_TwoSampleTTest.mat';
...
save_job = 'riss_con_%s_contrasts_OneSampleTTest_results.mat';
...
save_job = 'riss_con_%s_contrasts_TwoSampleTTest_results.mat';
