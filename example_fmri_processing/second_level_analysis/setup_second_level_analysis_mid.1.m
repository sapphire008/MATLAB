%rmpath(genpath(addmatlabpkg('spm8'))); clear classes;
addspm12;
...
% % job directory
% save_job = '/hsgs/projects/jhyoon1/midbrain_pilots/mid/jobfiles/normalization/mid_con_normalization.mat';
% 
...
SPM_loc = '/hsgs/projects/jhyoon1/midbrain_pilots/mid/analysis/GLM/';
source_dir = '/hsgs/projects/jhyoon1/midbrain_pilots/mid/analysis/GLM/';
result_dir = '/hsgs/projects/jhyoon1/midbrain_pilots/mid/analysis/SecondLevel/';
mask_loc = '/hsgs/projects/jhyoon1/midbrain_pilots/fullhead/subjects/coreg_TR2_normalized/';
condnames = {'Cue_gain5-null','Cue_gain1-null','Cue_gain0-null',...
    'Cue_lose0-null','Cue_lose1-null','Cue_lose5-null',...
    'Feedback_gain5_hit-null','Feedback_gain5_miss-null',...
    'Feedback_gain1_hit-null','Feedback_gain1_miss-null',...
    'Feedback_gain0_hit-null','Feedback_gain0_miss-null',...
    'Feedback_lose0_hit-null','Feedback_lose0_miss-null',...
    'Feedback_lose1_hit-null','Feedback_lose1_miss-null',...
    'Feedback_lose5_hit-null','Feedback_lose5_miss-null',...
    'Cue_gain5+Cue_gain1-Cue_gain0','Cue_lose0-(Cue_lose5+Cue_lose1)',...
    'Feedback_gain5_hit+Feedback_gain1_hit-Feedback_gain0_hit',...
    'Feedback_lose5_hit+Feedback_lose1_hit-Feedback_lose0_hit',...
    'Feedback_gain0_miss-(Feedback_gain5_miss+Feedback_gain1_miss)',...
    'Feedback_lose0_miss-(Feedback_lose5_miss+Feedback_lose1_miss)',...
    'Feedback_gain5_hit-Feedback_gain5_miss','Feedback_gain1_hit-Feedback_gain1_miss',...
    'Feedback_gain0_hit-Feedback_gain0_miss','Feedback_lose0_hit-Feedback_lose0_miss',...
    'Feedback_lose1_hit-Feedback_lose1_miss','Feedback_lose5_hit-Feedback_lose5_miss',...
    'Cue_gain5+Cue_gain1+Cue_gain0-(Cue_lose5+Cue_lose1+Cue_lose0)',...
    'Feedback_gain5_hit+Feedback_gain1_hit+Feedback_gain0_hit-(Feedback_gain5_miss+Feedback_gain1_miss+Feedback_gain0_miss)',...
    'Feedback_lose5_hit+Feedback_lose1_hit+Feedback_lose0_hit-(Feedback_lose5_miss+Feedback_lose1_miss+Feedback_lose0_miss)',...
    'Feedback_gain5_hit+Feedback_gain1_hit+Feedback_gain0_hit+Feedback_lose5_hit+Feedback_lose1_hit+Feedback_lose0_hit-(Feedback_gain5_miss+Feedback_gain1_miss+Feedback_gain0_miss+Feedback_lose5_miss+Feedback_lose1_miss+Feedback_lose0_miss)',...
    'Cue_gain5+Cue_gain1+Cue_lose1+Cue_lose5-(Cue_gain0+Cue_lose0)',...
    'Cue_gain5+Cue_gain1+Cue_gain0+Cue_lose0+Cue_lose1+Cue_lose5-null',...
    'Feedback_gain5_hit+Feedback_gain1_hit+Feedback_lose1_hit+Feedback_lose5_hit-(Feedback_gain0_hit+Feedback_lose0_hit)',...
    'Feedback_gain5_miss+Feedback_gain1_miss+Feedback_lose1_miss+Feedback_lose5_miss-(Feedback_gain0_miss+Feedback_lose0_miss)',...
    'Feedback_gain5_hit+Feedback_gain1_hit+Feedback_lose1_hit+Feedback_lose5_hit+Feedback_gain5_miss+Feedback_gain1_miss+Feedback_lose1_miss+Feedback_lose5_miss-(Feedback_gain0_hit+Feedback_lose0_hit+Feedback_gain0_miss+Feedback_lose0_miss)',...
    'Feedback_gain5_hit+Feedback_gain1_hit+Feedback_gain0_hit+Feedback_lose0_hit+Feedback_lose1_hit+Feedback_lose5_hit+Feedback_gain5_miss+Feedback_gain1_miss+Feedback_gain0_miss+Feedback_lose0_miss+Feedback_lose1_miss+Feedback_lose5_miss-null'};
replacename{20} = 'Cue_lose0-Cue_lose5-Cue_lose1';
replacename{21} = 'Feedback_gain5+1-0_hit';
replacename{22} = 'Feedback_lose5+1-0_hit';
replacename{23} = 'Feedback_gain0-5-1_miss';
replacename{24} = 'Feedback_lose0-5-1_miss';
replacename{31} = 'Cue_gainAll-Cue_loseAll';
replacename{32} = 'Feedback_gainAll_hit-Feedback_gainAll_miss';
replacename{33} = 'Feedback_loseAll_hit-Feedback_loseAll_miss';
replacename{34} = 'Feedback_All_hit-All_miss';
replacename{35} = 'Cue_gain5+Cue_gain1+Cue_lose1+Cue_lose5-Cue_gain0-Cue_lose0';
replacename{36} = 'Cue_gain5+Cue_gain1+Cue_gain0+Cue_lose0+Cue_lose1+Cue_lose5-null';
replacename{37} = 'Feedback_gain5+1+lose5+1_hit-Feedback_gain0+lose0_hit';
replacename{38} = 'Feedback_gain5+1+lose5+1_miss-Feedback_gain0+lose0_miss';
replacename{39} = 'Feedback_allpositive_gain_lose-allbaseline_gain_lose';
replacename{40} = 'Feedback_everything-null';

job_dir = '/hsgs/projects/jhyoon1/midbrain_pilots/mid/jobfiles/SecondLevel/';
save_job = 'mid_2ndlvl_OneSampleTTest.mat';
...
save_job = 'mid_2ndlvl_contrasts_OneSampleTTest_result.mat';
...
save_job = 'mid_2ndlvl_TwoSampleTTest.mat';
...
for m = 1:length(condnames) % for each model
    ...
    % make a directory for the current model
    if ~exist('replacename','var') || isempty(replacename{m})
        current_dir = fullfile(result_dir,'SecondLevel_BetweenGroup',condnames{m});
    else
        current_dir = fullfile(result_dir,'SecondLevel_BetweenGroup',replacename{m});
    end
    % remove some illgeal characters
    IND = intersect(regexp(current_dir,'(\W)'),...
        intersect(regexp(current_dir,'(\S)'),regexp(current_dir,'[^_-+]')));
...
save_job = 'mid_2ndlvl_contrasts_TwoSampleTTest_results.mat';
