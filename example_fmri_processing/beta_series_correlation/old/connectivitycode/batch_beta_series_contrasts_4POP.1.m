...
subject_dir = '/nfs/jong_exp/PFC_basalganglia/TMS_Study/Jong_postTMS/analysis/4POP/beta_series_correlations/';


% subject_SPMmat_path is the path in the subject's folders where the
% SPM.mat is located (in example above, 'conn/')
subject_SPMmat_path = '/nfs/jong_exp/PFC_basalganglia/TMS_Study/Jong_postTMS/analysis/4POP/multivariate/';
...
% e.g.: cueB-CueA
output_prefix = 'R_atanh_corr_SNleftProbeRed-Green';
...
for i = 1:length(all_subs)
    files = dir([subject_dir, all_subs{i}, '/R_atanh_corr_' img_prefix, '*']);
