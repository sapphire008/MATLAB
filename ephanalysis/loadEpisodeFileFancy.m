...
% Expands dacData and ttlData to give it meaning
% [data, info] = loadEpisodeFileFancy(filename)
% [data info] = loadEpisodeFileFancy
% info = loadEpisodeFileFancy(filename, 'infoOnly');
function [zData, info] = loadEpisodeFileFancy(filename, infoOnly)
