function data_folder = eph_cellpath(cell_label)
...
month_dict = struct('Jan','01.January','Feb','02.February','Mar','03.March',...
    'Apr','04.April','May','05.May', 'Jun','06.Jun', 'Jul','07.July',...
...
data_folder = fullfile(year_dir, month_dir, data_folder, [cell_label,'.dat']);
end