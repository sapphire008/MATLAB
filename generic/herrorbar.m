function hh = herrorbar(x, y, l, u, symbol, tee_size, varargin)
...
tee = (max(y(:))-min(y(:)))*tee_size; % make tee .02 x-distance for error bars
...
h = plot(xb,yb,esymbol, varargin{:}); hold on
