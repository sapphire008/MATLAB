...
subjects = {'M3020_CNI_011314_adjusted_scale_factor','M3020_CNI_011314_new_recon'};
tasks = {'RestingState','stop_signal','mid'};
blocks = {{''},{'block1','block2'},{'block1','block2'}};
% list of folders
...
for s = 2:length(subjects)
    ...
    % reslice
    disp('reslicing...');
    P = FileFun(@reslice_nii,P,[],{'r','front'},false,[],false,[],0);
    % resample
    disp('resampling...');
    ...
    FILEPATH = unique(cellfun(@fileparts,P));
    clear P;
    spm_jobman('run',matlabbatch);
