function stringData = fitAlpha(yData, timePerPoint, startingTime, axisHandle)
...
if ~nargin
    ...
    line('parent', axisHandle, 'color', [1 0 0], 'buttondownfcn', ['set(get(get(gcbo, ''parent''), ''userdata''), ''string'', ''Amp = ' sprintf('%1.1f', estimates(1) / exp(1)) ' mV, tau = ' sprintf('%1.1f', estimates(2) * 1000) ' ms'')'],  'xData', startingTime + xData*1000, 'ydata', yData);
