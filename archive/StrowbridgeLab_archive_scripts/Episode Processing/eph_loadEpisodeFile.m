function zData = eph_loadEpisodeFile(filename, infoOnly, useMatrix)
...
elseif (protocolType == 25) && (acquireVersion >= 8)
    zData = readData(filename, infoOnly, useMatrix);
else
...
%% For new style data
function zData = readData(filename, infoOnly, useMatrix)
% Main read program for new Synapse4
%
% Last revised 11 Feb 2015
