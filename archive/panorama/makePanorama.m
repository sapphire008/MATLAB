function [shearedImg, finalImg] = makePanorama(images, circular, homogs, Ycrop, f, k1, k2)
% This is the core module. This code takes a set of images, and an array 
% of pairwise homographies, and creates the panorama from them. It can 
% create both partial and complete (full 360 degree) panoramas.
% 
% circular: flag [true|false] whether or not use circular stitching
% homogs: output from model_homography, [WidthOrigin, HeightOrigin]
% Ycrop: crop Y axis (rows)
% f, k1, k2, see cylinder_projection
